...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window x-full-screen" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <column label="菜品名称" name="ENAME" type="String" xid="xid5"></column>
  <column label="菜品图片" name="FNAME" type="String" xid="xid6"></column>
  <column label="菜品类型" name="TYPE" type="String" xid="xid7"></column></div>
...
<!--  <div xid="div13" style="height:100%;width:100%;">
  ...
  <div xid="div13" style="height:100%;width:100%;" class="swiper-container1"><div xid="div8" style="height:100%;width:100%;" class="swiper-wrapper">
   ...
   <div class="x-scroll-content" xid="menucontent" style="height:100%;"><div component="$UI/system/components/justep/list/list" class="x-list x-cards" xid="list2" style="height:100%;">
   ...
   <div class="col" xid="col1" style="width:100%;height:100%;padding-top:10px;">
    ...
    <input component="$UI/system/components/justep/input/input" class="form-control pull-right" xid="inputdata" style="width:40%;margin-right:10px;" list="keylist" autoComplete="false">
     <datalist id="keylist" xid="default1">
      ...
      <option label="12345" value="13345" xid="default4"></option>
      <option label="123456" value="123456" xid="default5"></option></datalist> </input> 
    <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group" tabbed="true" xid="btncontainer" style="height:40px;width:50%;">
     <div component="$UI/system/components/justep/button/button" class="btn btn-success btn-drag" label="Entity" xid="button2">
      <i xid="i2"></i>
      <span xid="span2">Entity</span></div> 
     </div> </div> </div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row13" style="width:100%;height:90%;">
   <div class="x-col" xid="col18" style="height: 100%; width: 100%;"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView3" style="height:100%;width:100%;">
